...
knitr::opts_chunk$set(fig.path = paste0("figures-", params$lang, "/"))
...
# Plottitler og akseetiketter finnes på norsk og engelsk, styrt av params$lang,
# slik at både den norske og den engelske versjonen av porteføljesida kan
# vise figurer med korrekt språk.
t <- function(no, en) if (params$lang == "en") en else no
...
df_oslo %>%
  ...
  labs(title = t("Biltrafikk mot Oslo i september 2022", "Car traffic toward Oslo, September 2022"),
       x = "",
...
df_oslo %>%
  ...
  theme(axis.text.x = element_text(size = 8),
        ...
        strip.text = element_text(size = 10),
        legend.position = "none") +
  labs(title = t("Test av dekningsgrad", "Data coverage rate test"),
       x = "",
       y = t("Dekningsgrad i prosent", "Coverage rate (%)"))
...
df_des %>%
  ...
  theme(axis.text.x = element_text(size = 8, angle = 60),
        ...
        strip.text = element_text(size = 10),
        legend.position = "none") +
  labs(title = t("Biltrafikk mot Oslo november 2022 - januar 2023", "Car traffic toward Oslo, November 2022 - January 2023"),
       x = "",
       y = t("Antall lette kjøretøy", "Number of light vehicles"))
