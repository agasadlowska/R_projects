...
plot_em <- function(proplist) {
  ggplot(data = proplist,
    ...
    geom_text(mapping = aes(label = proposals), size = 3)
}
...
links_2013_2017 <- list(
  "https://www.stortinget.no/no/saker-og-publikasjoner/publikasjoner/representantforslag/?tab=Party&pid=2014-2015&m=all",
  "https://www.stortinget.no/no/saker-og-publikasjoner/publikasjoner/representantforslag/?tab=Party&pid=2015-2016&m=all",
  "https://www.stortinget.no/no/saker-og-publikasjoner/publikasjoner/representantforslag/?tab=Party&pid=2016-2017&m=all"
)
...
link_2013_2014 <- read_html(
  "https://www.stortinget.no/no/saker-og-publikasjoner/publikasjoner/representantforslag/?tab=Party&pid=2013-2014&m=all")
